...
from cbrain.preprocessing.convert_dataset_land import preprocess
from cbrain.preprocessing.shuffle_dataset_land import shuffle
from cbrain.preprocessing.compute_normalization_land import normalize
...
def main(args):
    ...
    preprocess(args.in_dir, args.in_fns, args.out_dir, args.out_fn, args.vars, args.SPCAM_v)
    print(' ')
    ...
    if args.val_in_fns is not None:
        ...
        preprocess(args.in_dir, args.val_in_fns, args.out_dir, args.val_out_fn, args.vars, args.SPCAM_v)
...
if __name__ == '__main__':
    ...
    p.add('--SPCAM_v', type=int, default=3, help='Determine the SPCAM Data version')
